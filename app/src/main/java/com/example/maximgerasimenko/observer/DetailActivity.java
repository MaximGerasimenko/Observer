    ...
    private void loadJSON(){
        ...
        try{
            if(BuildConfig.THE_MOVIE_DB_API_TOKEN.isEmpty()){
                Toast.makeText(getApplicationContext(), "Please obtain you API key", Toast.LENGTH_SHORT).show();
                return;
            }
            Client Client = new Client();
            com.example.maximgerasimenko.observer.api.Service apiService = Client.getClient().create(com.example.maximgerasimenko.observer.api.Service.class);
